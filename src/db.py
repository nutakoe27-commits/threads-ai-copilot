...
MIGRATIONS = [
    ...
    # Вакансии в продажи на сайте самой компании: единственный
    # событийный сигнал в системе (DECISIONS.md, Р-027).
    ("companies", "site_hiring", "TEXT"),
    ...
    # ok — письмо опирается на факты и годится к отправке;
    # thin — фактов меньше минимума, письмо в утренний список не идёт.
    # Письмо с одним фактом опасно именно в новом каркасе: текст прямым
